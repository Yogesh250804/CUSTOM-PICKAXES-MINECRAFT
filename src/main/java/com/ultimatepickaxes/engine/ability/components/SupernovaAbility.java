...
public class SupernovaAbility implements AbilityComponent {
    ...
    public boolean execute(JsonObject params, AbilityContext context) {
        ...
        world.playSound(null, center, SoundEvents.ENTITY_FIREWORK_ROCKET_BLAST, SoundCategory.PLAYERS, 2.0f, 1.2f);
        world.spawnParticles(ParticleTypes.FLASH, center.getX() + 0.5, center.getY() + 1, center.getZ() + 0.5, 10, 0.5, 0.5, 0.5, 0.1);
        world.spawnParticles(ParticleTypes.GLOW, center.getX() + 0.5, center.getY() + 1, center.getZ() + 0.5, 100, radius / 2.0, 1.0, radius / 2.0, 0.1);
        ...
        for (LivingEntity entity : world.getEntitiesByClass(LivingEntity.class, area, e -> e != context.getPlayer())) {
            ...
            entity.damage(world.getDamageSources().onFire(), 10.0f);
        }
        return true;
    }
}
